...
from configs.pathConfig import DEV_EXCEL_PATH, RELEASE_EXCEL_PATH, GLOBAL_EXCEL_PATH
...
class BasePageMain:
    def __init__(self, serial_number=None, dev=None, is_mobile_device=False, is_monitor=False, excel_path=None):
        # 不打印airtest日志
...
class BasePage(BasePageMain):
    def __init__(self, serial_number=None, dev=None, is_mobile_device=False, is_monitor=False, excel_path=None):
        ...
        if excel_path is None:
            self.excelTools = ExcelTools(DEV_EXCEL_PATH)
