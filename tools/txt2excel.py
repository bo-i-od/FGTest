...
if __name__ == "__main__":
    ...
    # excel_list = [ 'ITEM_PACKAGE.xlsm', 'ITEM_CONVERT_RULE.xlsm', 'MINIGAME_PROGRESS_REWARD.xlsm', 'POINT_PROGRESS_REWARD.xlsm', 'HIDDEN_TREASURE_LEVEL.xlsm', 'MINIGAME_HIDDENTREASURE_LEVEL.xlsm', ]
    excel_list =[ 'POINT_PROGRESS_REWARD.xlsm']
